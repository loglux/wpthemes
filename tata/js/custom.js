...
$j.fn.setNav = function(){
	$j('#menu-sidebar li ul').css({display: 'none'});
	
	$j( 'ul#menu-sidebar > li:has( ul li.current-menu-item )' ).each(function()
	{	
     	$j(this).find('ul.sub-menu').css({overflow:'visible', height:'auto', display: 'block'});
	});
	
	$j('ul#menu-sidebar > li:has( ul.sub-menu )').click(function()
	{
	...
	$j('ul#menu-sidebar > li > ul.sub-menu li ').click(function()
	{
