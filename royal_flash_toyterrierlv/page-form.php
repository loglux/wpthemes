...
<div class="ss-form-heading"><h1 class="ss-form-title">Puppy Questionnaire</h1>
<p></p>
<div class="ss-form-desc ss-no-ignore-whitespace">If you are interested in one of our puppies, please tell us a little about yourself.</div>
...
<iframe name="hidden_iframe" id="hidden_iframe" style="display:none;" onload="if(submitted) {window.location='http://www.toyterrier.lv/confirmation/';}"></iframe>
<!--form action="https://docs.google.com/a/mycavalier.lv/spreadsheet/formResponse?formkey=dFFEYU1rN3RDWjg1S0JKOHB2UGlSMXc6MQ&amp;ifq" method="post" target="hidden_iframe" onsubmit="submitted=true;" id="ss-form" name="ss-form"-->
    
<form action="https://docs.google.com/forms/d/1HLdpBIv7MrOXXs3wWx-MhAB7lWypp1ttMdyINTnau3g/formResponse" method="post" target="hidden_iframe" onsubmit="submitted=true;" id="ss-form" name="ss-form">
...
<div class="ss-item ss-item-required ss-text"><div class="ss-form-entry">
        <label class="ss-q-title" for="entry_0"><?php _e('Full Name', 'royal_flash');  ?>
            <span class="ss-required-asterisk">*</span></label>
        <label class="ss-q-help" for="entry_0"></label>
        <input type="text" name="entry.348416398.single" value="" class="required ss-q-short" id="entry_348416398">
</div></div></div>
 
<!--1--> 
<br> <div class="errorbox-good">
<div class="ss-item ss-item-required ss-text"><div class="ss-form-entry"><label class="ss-q-title" for="entry_1"><?php _e('Street Address (where the puppy will live)', 'royal_flash');  ?><span class="ss-required-asterisk">*</span></label>
<label class="ss-q-help" for="entry_1"></label>
<input type="text" name="entry.1.single" value="" class="required ss-q-short" id="entry_1"></div></div></div>
...
<!--Are you prepared to make a lifetime (10-15,,,,-->
<!--12-->
<br> <div class="errorbox-good">
